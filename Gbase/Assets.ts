module Gbase {
    ...
    export class Assets {
        ...
        constructor(imagePath: string = "assets/images", audioPath: string = "assets/sounds", assetScale?: number) {

            this.assetScale = assetscale;
            this.audioPath = audioPath;

            if (assetscale) this.imagePath = imagePath += "_" + assetscale + "x";
            else this.imagePath = imagePath;

        }

        public loadAssets(assetscale: number = 1): createjs.LoadQueue {
