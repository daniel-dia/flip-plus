    ...
    (function (DisplayObjects) {
        var BonusNotification = (function (_super) {
            ...
            function BonusNotification() {
                ...
                Image.regX = 304 / 2;
                Image.x = 250;
                Text = gameui.AssetsManager.getBitmapText("SEU BONUS\nEST� PRONTO!", "fontWhite");
                Text.pivot.x = Text.textWidth / 2;
                Text.pivot.y = Text.textHeight / 2;
                Text.x = defaultWidth / 2;
                Text.align = 'center';
                Botao = new gameui.BitmapTextButton("Play", "fontWhite", "menu/btmusicon", function () { _this.emit("play"); });
                Botao.x = defaultWidth - 250;
                _this.content.addChild(Text);
                _this.content.addChild(Image);
                _this.content.addChild(Botao);
                return _this;
            }
